...
export const PurchaseHistoryModal: React.FC<PurchaseHistoryModalProps> = ({ 
  ...
  return (
    <ModalBase isOpen={true} onClose={onClose} className={`${activeTheme.cardBg} ${activeTheme.text}`}>
      <ModalHeader className={`${activeTheme.headerBg} border-white/20`}>
        <h2 className={`text-xl font-black ${activeTheme.text} flex items-center gap-2 pr-0`}>
      ...
      <ModalFooter className={`${activeTheme.headerBg} border-white/20`}>
        <button
          onClick={onClose}
