...
#FindMyPuppy #HiddenPuppies #GameTime`;
  ...
  return (
    <ModalBase isOpen={isOpen} onClose={onClose} maxWidth="sm" className="bg-white">
      <ModalHeader className="bg-gradient-to-r from-purple-100 to-pink-100 border-purple-200">
