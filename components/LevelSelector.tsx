  ...
  return (
    <div className={`flex flex-col h-full ${bgClass} relative overflow-hidden transition-colors duration-500`}>
      ...
      <div className="flex-1 overflow-y-auto p-4 bg-transparent z-10 relative hide-scrollbar">
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4 pb-24">
          {levels.map((level) => {
      ...
      {/* Ad Banner - Fixed Footer (outside scrollable area) */}
      <div className="shrink-0 w-full flex justify-center items-center bg-white/20 backdrop-blur-md border-t border-white/30 py-2 z-20">
        <AdBanner 
