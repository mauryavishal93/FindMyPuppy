...
export const AdBanner: React.FC<AdBannerProps> = ({
  ...
  return (
    <div 
      ref={adRef}
      className={`mobile-ad-section ad-banner-container bg-slate-100/50 backdrop-blur-sm border border-slate-200 rounded-xl flex items-center justify-center overflow-hidden ${className}`}
    >
