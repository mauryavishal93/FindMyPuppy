        ...
        <div className="border border-slate-200 rounded-xl overflow-hidden shadow-sm">
           ...
           <div className="divide-y divide-slate-100">
              ...
              <div className="grid grid-cols-4 gap-2 p-3 bg-slate-50 items-center">
                 ...
                 <div className="col-span-3 text-xs text-slate-600 space-y-1">
                    <div className="flex items-center gap-2"><i className="fas fa-clock w-4 text-center text-slate-400"></i> <span>120 Seconds (2m)</span></div>
              ...
              <div className="grid grid-cols-4 gap-2 p-3 bg-white items-center">
                 ...
                 <div className="col-span-3 text-xs text-slate-600 space-y-1">
                    <div className="flex items-center gap-2"><i className="fas fa-clock w-4 text-center text-slate-400"></i> <span>90 Seconds (1.5m)</span></div>
